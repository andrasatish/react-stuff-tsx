...
const TouristForm = () => {
    ...
    const { touristList, setTouristList, editedObj, setEditedObj, setModalConfig } = useContext<any>(TouristContext);
    ...
    const onSubmit = () => {
       const newData = [form.getFieldsValue(), ...touristList];
       setTouristList(newData);
       form.resetFields();
    //    setModalConfig({
    //     modalTitle: 'Do you want to submit the tourist details?',
    //     isModalOpen: true
    //    })
    }
